...
class WeatherHelperApp:
    ...
    def _create_main_layout(self):
        ...
        self.main_frame.columnconfigure(
            0, weight=0, minsize=360
        )  # Side panel - optimized width
        ...
        self.main_frame.rowconfigure(
            1, weight=1
        )  # Content area (sidebar and main table)
    ...
    def _setup_main_table(self):
        ...
        scrollbar = ttk.Scrollbar(
            table_frame, orient="vertical", command=self.main_table.yview
        )
    ...
    def _update_side_panel(self):
        ...
        try:
            top_locs = get_top_locations_for_date(
                self.all_location_processed, self.selected_date, top_n=5
            )
    ...
    def _add_table_row(self, hour):
        ...
        try:
            ...
            self.main_table.insert(
                "", "end", values=(time_str, temp, wind, clouds, rain), tags=(tag,)
            )
