...
LOCATIONS: Dict[str, Location] = {
    ...
    "arriondas": Location("arriondas", "Arriondas", 43.3861, 5.1868),
    ...
    "lagos_covadonga": Location(
        "lagos_covadonga", "Lagos de Covadonga", 43.1600, -4.5900
    ),
    "cangas_de_narcea": Location(
        "cangas_de_narcea", "Cangas de Narcea", 43.1774, -6.5498
    ),
}
